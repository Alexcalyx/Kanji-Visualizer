...
function HomePage() {
  ...
  const gradeLinkStyle =
    "text-sm hover:underline px-3 py-2 rounded transition-colors border border-transparent hover:border-gray-300 dark:hover:border-gray-600"; // Added subtle border on hover
